...
import CalculatorItem from '@/components/calculator/CalculatorItem.vue'
...
<template>
  <div class="calculator-main">
    <Button width="75px" height="75px" backgroundColor="#f1f3f6" @click="back">
      <Icon color="#acb8e9" size="48">
        <AngleLeft />
      </Icon>
    </Button>
